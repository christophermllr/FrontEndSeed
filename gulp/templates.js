...
// Root App Templates
gulp.task('templates:app', ['clean',  'scripts:app', 'styles:app', 'styles:themes', 'bootstrap', 'inject-jade'], function () {
...
// Views
gulp.task('templates:views', ['clean', 'scripts:app', 'styles:app', 'styles:themes', 'bootstrap', 'inject-jade'], function () {
